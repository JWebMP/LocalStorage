...
public class LocalStorageIntercepter
		implements DataCallIntercepter<LocalStorageIntercepter>,
		           AjaxCallIntercepter<LocalStorageIntercepter>
{
	private static final Logger log = LogFactory.getLog("LocalStorageInterceptor");
